...
protected:
	...
	UINT								m_PreviousPrimType;
	const ID3D11ShaderResourceView*		m_pPreviousDiffuseTexture;
	const ID3D11ShaderResourceView*		m_pPreviousNormalTexture;
	const ID3D11ShaderResourceView*		m_pPreviousSpecularTexture;
