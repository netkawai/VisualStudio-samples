...
HRESULT CDXUTDialogResourceManager::OnD3D11CreateDevice( ID3D11Device* pd3dDevice, ID3D11DeviceContext* pd3d11DeviceContext )
{
    ...
    DXUT_SetDebugName( m_pPSRenderUIUntex11, "CDXUTDialogResourceManagerPS2" );
    ...
    DXUT_SetDebugName( m_pDepthStencilStateUI11, "CDXUTDialogResourceManager_Depth" );
  ...
  //  DXUT_SetDebugName( m_pRasterizerStateUI11, "CDXUTDialogResourceManager_Raster" );
    ...
    DXUT_SetDebugName( m_pBlendStateUI11, "CDXUTDialogResourceManager_Blend" );
    ...
    DXUT_SetDebugName( m_pSamplerStateUI11, "CDXUTDialogResourceManager_SS" );
    ...
    DXUT_SetDebugName( m_pInputLayout11, "CDXUTDialogResourceManager_IL" );
...
void CDXUTDialogResourceManager::EndSprites11( ID3D11Device* pd3dDevice, ID3D11DeviceContext* pd3dImmediateContext )
{
    ...
    if( m_SpriteBufferBytes11 < SpriteDataBytes )
    {
        ...
        DXUT_SetDebugName( m_pSpriteBuffer11, "CDXUTDialogResourceManager_SB" );
    }
...
HRESULT InitFont11( ID3D11Device* pd3d11Device, ID3D11InputLayout* pInputLayout )
{
    ...
    if (g_pFont11)
    {
        ...
        DXUT_SetDebugName( pRes, "DXUT Text11 res" );
        SAFE_RELEASE( pRes );
    }    
