...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"WinUI3CApp.MainWindow"))
    {
        return winrt_make_WinUI3CApp_MainWindow();
    }

    if (requal(name, L"WinUI3CApp.XamlMetaDataProvider"))
    {
        return winrt_make_WinUI3CApp_XamlMetaDataProvider();
    }
