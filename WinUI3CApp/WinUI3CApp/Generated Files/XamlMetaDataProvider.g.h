...
namespace winrt::WinUI3CApp::implementation
{
    ...
    struct __declspec(empty_bases) XamlMetaDataProvider_base : implements<D, WinUI3CApp::XamlMetaDataProvider, I...>
    {
        using base_type = XamlMetaDataProvider_base;
        using class_type = WinUI3CApp::XamlMetaDataProvider;
        using implements_type = typename XamlMetaDataProvider_base::implements_type;
        using implements_type::implements_type;
        
        hstring GetRuntimeClassName() const
        {
            return L"WinUI3CApp.XamlMetaDataProvider";
        }
    };
}
namespace winrt::WinUI3CApp::factory_implementation
{
    ...
    {
        using instance_type = WinUI3CApp::XamlMetaDataProvider;
