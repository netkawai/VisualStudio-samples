...
namespace winrt::impl
{
    ...
    {
        WINRT_VERIFY_(0, WINRT_IMPL_SHIM(winrt::Microsoft::UI::Composition::SystemBackdrops::ISystemBackdropControllerWithTargets)->remove_StateChanged(impl::bind_in(token)));
    }
