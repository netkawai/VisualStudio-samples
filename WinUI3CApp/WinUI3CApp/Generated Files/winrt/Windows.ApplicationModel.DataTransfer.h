...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_ApplicationModel_DataTransfer_IDataPackage<D>::OperationCompleted(winrt::event_token const& eventCookie) const noexcept
    {
    ...
    template <typename D> auto consume_Windows_ApplicationModel_DataTransfer_IDataPackage<D>::Destroyed(winrt::event_token const& eventCookie) const noexcept
    {
