...
namespace winrt::impl
{
    ...
    struct consume_Microsoft_UI_Composition_IAnimationController
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::AnimationControllerProgressBehavior) ProgressBehavior() const;
        WINRT_IMPL_AUTO(void) ProgressBehavior(winrt::Microsoft::UI::Composition::AnimationControllerProgressBehavior const& value) const;
    ...
    {
        WINRT_IMPL_AUTO(void) PopulatePropertyInfo(param::hstring const& propertyName, winrt::Microsoft::UI::Composition::AnimationPropertyInfo const& propertyInfo) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::AnimationPropertyAccessMode) AccessMode() const;
        WINRT_IMPL_AUTO(void) AccessMode(winrt::Microsoft::UI::Composition::AnimationPropertyAccessMode const& value) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionObject) GetResolvedCompositionObject() const;
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionEasingFunctionMode) Mode() const;
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionColorSpace) InterpolationColorSpace() const;
        WINRT_IMPL_AUTO(void) InterpolationColorSpace(winrt::Microsoft::UI::Composition::CompositionColorSpace const& value) const;
        WINRT_IMPL_AUTO(void) InsertKeyFrame(float normalizedProgressKey, winrt::Windows::UI::Color const& value) const;
        WINRT_IMPL_AUTO(void) InsertKeyFrame(float normalizedProgressKey, winrt::Windows::UI::Color const& value, winrt::Microsoft::UI::Composition::CompositionEasingFunction const& easingFunction) const;
    };
    ...
    struct consume_Microsoft_UI_Composition_ICompositionAnimation
    {
        ...
        WINRT_IMPL_AUTO(void) SetReferenceParameter(param::hstring const& key, winrt::Microsoft::UI::Composition::CompositionObject const& compositionObject) const;
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::InitialValueExpressionCollection) InitialValueExpressions() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(void) SetExpressionReferenceParameter(param::hstring const& parameterName, winrt::Microsoft::UI::Composition::IAnimationObject const& source) const;
    };
    ...
    struct consume_Microsoft_UI_Composition_ICompositionAnimationGroup
    {
        ...
        WINRT_IMPL_AUTO(void) Add(winrt::Microsoft::UI::Composition::CompositionAnimation const& value) const;
        WINRT_IMPL_AUTO(void) Remove(winrt::Microsoft::UI::Composition::CompositionAnimation const& value) const;
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(uint64_t) ApiVersion() const;
    };
    ...
    struct consume_Microsoft_UI_Composition_ICompositionCapabilities
    {
        ...
        WINRT_IMPL_AUTO(winrt::event_token) Changed(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Composition::CompositionCapabilities, winrt::Windows::Foundation::IInspectable> const& handler) const;
        ...
        [[nodiscard]] Changed_revoker Changed(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Composition::CompositionCapabilities, winrt::Windows::Foundation::IInspectable> const& handler) const;
    ...
    struct consume_Microsoft_UI_Composition_ICompositionCommitBatch
    {
        ...
        WINRT_IMPL_AUTO(winrt::event_token) Completed(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Foundation::IInspectable, winrt::Microsoft::UI::Composition::CompositionBatchCompletedEventArgs> const& handler) const;
        ...
        [[nodiscard]] Completed_revoker Completed(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Foundation::IInspectable, winrt::Microsoft::UI::Composition::CompositionBatchCompletedEventArgs> const& handler) const;
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionShapeCollection) Shapes() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::DirectX::DirectXAlphaMode) AlphaMode() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::DirectX::DirectXPixelFormat) PixelFormat() const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CubicBezierEasingFunction) CreateCubicBezierEasingFunction(winrt::Microsoft::UI::Composition::Compositor const& owner, winrt::Windows::Foundation::Numerics::float2 const& controlPoint1, winrt::Windows::Foundation::Numerics::float2 const& controlPoint2) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::LinearEasingFunction) CreateLinearEasingFunction(winrt::Microsoft::UI::Composition::Compositor const& owner) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::StepEasingFunction) CreateStepEasingFunction(winrt::Microsoft::UI::Composition::Compositor const& owner) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::StepEasingFunction) CreateStepEasingFunction(winrt::Microsoft::UI::Composition::Compositor const& owner, int32_t stepCount) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::BackEasingFunction) CreateBackEasingFunction(winrt::Microsoft::UI::Composition::Compositor const& owner, winrt::Microsoft::UI::Composition::CompositionEasingFunctionMode const& mode, float amplitude) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::BounceEasingFunction) CreateBounceEasingFunction(winrt::Microsoft::UI::Composition::Compositor const& owner, winrt::Microsoft::UI::Composition::CompositionEasingFunctionMode const& mode, int32_t bounces, float bounciness) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CircleEasingFunction) CreateCircleEasingFunction(winrt::Microsoft::UI::Composition::Compositor const& owner, winrt::Microsoft::UI::Composition::CompositionEasingFunctionMode const& mode) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::ElasticEasingFunction) CreateElasticEasingFunction(winrt::Microsoft::UI::Composition::Compositor const& owner, winrt::Microsoft::UI::Composition::CompositionEasingFunctionMode const& mode, int32_t oscillations, float springiness) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::ExponentialEasingFunction) CreateExponentialEasingFunction(winrt::Microsoft::UI::Composition::Compositor const& owner, winrt::Microsoft::UI::Composition::CompositionEasingFunctionMode const& mode, float exponent) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::PowerEasingFunction) CreatePowerEasingFunction(winrt::Microsoft::UI::Composition::Compositor const& owner, winrt::Microsoft::UI::Composition::CompositionEasingFunctionMode const& mode, float power) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::SineEasingFunction) CreateSineEasingFunction(winrt::Microsoft::UI::Composition::Compositor const& owner, winrt::Microsoft::UI::Composition::CompositionEasingFunctionMode const& mode) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionBrush) GetSourceParameter(param::hstring const& name) const;
        WINRT_IMPL_AUTO(void) SetSourceParameter(param::hstring const& name, winrt::Microsoft::UI::Composition::CompositionBrush const& source) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionEffectBrush) CreateBrush() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::hresult) ExtendedError() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionEffectFactoryLoadStatus) LoadStatus() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionEffectSourceParameter) Create(param::hstring const& name) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionGeometry) Geometry() const;
        WINRT_IMPL_AUTO(void) Geometry(winrt::Microsoft::UI::Composition::CompositionGeometry const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionViewBox) ViewBox() const;
        WINRT_IMPL_AUTO(void) ViewBox(winrt::Microsoft::UI::Composition::CompositionViewBox const& value) const;
    };
    ...
    struct consume_Microsoft_UI_Composition_ICompositionGradientBrush
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Numerics::float2) CenterPoint() const;
        WINRT_IMPL_AUTO(void) CenterPoint(winrt::Windows::Foundation::Numerics::float2 const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionColorGradientStopCollection) ColorStops() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionGradientExtendMode) ExtendMode() const;
        WINRT_IMPL_AUTO(void) ExtendMode(winrt::Microsoft::UI::Composition::CompositionGradientExtendMode const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionColorSpace) InterpolationSpace() const;
        WINRT_IMPL_AUTO(void) InterpolationSpace(winrt::Microsoft::UI::Composition::CompositionColorSpace const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Numerics::float2) Offset() const;
        WINRT_IMPL_AUTO(void) Offset(winrt::Windows::Foundation::Numerics::float2 const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) RotationAngle() const;
        WINRT_IMPL_AUTO(void) RotationAngle(float value) const;
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionMappingMode) MappingMode() const;
        WINRT_IMPL_AUTO(void) MappingMode(winrt::Microsoft::UI::Composition::CompositionMappingMode const& value) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionDrawingSurface) CreateDrawingSurface(winrt::Windows::Foundation::Size const& sizePixels, winrt::Microsoft::Graphics::DirectX::DirectXPixelFormat const& pixelFormat, winrt::Microsoft::Graphics::DirectX::DirectXAlphaMode const& alphaMode) const;
        WINRT_IMPL_AUTO(winrt::event_token) RenderingDeviceReplaced(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Composition::CompositionGraphicsDevice, winrt::Microsoft::UI::Composition::RenderingDeviceReplacedEventArgs> const& handler) const;
        ...
        [[nodiscard]] RenderingDeviceReplaced_revoker RenderingDeviceReplaced(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Composition::CompositionGraphicsDevice, winrt::Microsoft::UI::Composition::RenderingDeviceReplacedEventArgs> const& handler) const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionDrawingSurface) CreateDrawingSurface2(winrt::Windows::Graphics::SizeInt32 const& sizePixels, winrt::Microsoft::Graphics::DirectX::DirectXPixelFormat const& pixelFormat, winrt::Microsoft::Graphics::DirectX::DirectXAlphaMode const& alphaMode) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionVirtualDrawingSurface) CreateVirtualDrawingSurface(winrt::Windows::Graphics::SizeInt32 const& sizePixels, winrt::Microsoft::Graphics::DirectX::DirectXPixelFormat const& pixelFormat, winrt::Microsoft::Graphics::DirectX::DirectXAlphaMode const& alphaMode) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionMipmapSurface) CreateMipmapSurface(winrt::Windows::Graphics::SizeInt32 const& sizePixels, winrt::Microsoft::Graphics::DirectX::DirectXPixelFormat const& pixelFormat, winrt::Microsoft::Graphics::DirectX::DirectXAlphaMode const& alphaMode) const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<winrt::Microsoft::UI::Composition::ICompositionSurface>) CaptureAsync(winrt::Microsoft::UI::Composition::Visual const& captureVisual, winrt::Windows::Graphics::SizeInt32 const& size, winrt::Microsoft::Graphics::DirectX::DirectXPixelFormat const& pixelFormat, winrt::Microsoft::Graphics::DirectX::DirectXAlphaMode const& alphaMode, float sdrBoost) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::VisualUnorderedCollection) Targets() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::VisualUnorderedCollection) ExclusionsFromTargets() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionBrush) Mask() const;
        WINRT_IMPL_AUTO(void) Mask(winrt::Microsoft::UI::Composition::CompositionBrush const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionBrush) Source() const;
        WINRT_IMPL_AUTO(void) Source(winrt::Microsoft::UI::Composition::CompositionBrush const& value) const;
    };
    ...
    struct consume_Microsoft_UI_Composition_ICompositionMipmapSurface
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::DirectX::DirectXPixelFormat) PixelFormat() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Graphics::SizeInt32) SizeInt32() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionDrawingSurface) GetDrawingSurfaceForLevel(uint32_t level) const;
    };
    ...
    struct consume_Microsoft_UI_Composition_ICompositionObject
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionPropertySet) Properties() const;
        WINRT_IMPL_AUTO(void) StartAnimation(param::hstring const& propertyName, winrt::Microsoft::UI::Composition::CompositionAnimation const& animation) const;
    ...
    struct consume_Microsoft_UI_Composition_ICompositionObject2
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::ImplicitAnimationCollection) ImplicitAnimations() const;
        WINRT_IMPL_AUTO(void) ImplicitAnimations(winrt::Microsoft::UI::Composition::ImplicitAnimationCollection const& value) const;
        WINRT_IMPL_AUTO(void) StartAnimationGroup(winrt::Microsoft::UI::Composition::ICompositionAnimationBase const& value) const;
        WINRT_IMPL_AUTO(void) StopAnimationGroup(winrt::Microsoft::UI::Composition::ICompositionAnimationBase const& value) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::AnimationController) TryGetAnimationController(param::hstring const& propertyName) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(void) StartAnimation(param::hstring const& propertyName, winrt::Microsoft::UI::Composition::CompositionAnimation const& animation, winrt::Microsoft::UI::Composition::AnimationController const& animationController) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(void) StartAnimationWithIAnimationObject(winrt::Microsoft::UI::Composition::IAnimationObject const& target, param::hstring const& propertyName, winrt::Microsoft::UI::Composition::CompositionAnimation const& animation) const;
        WINRT_IMPL_AUTO(void) StartAnimationGroupWithIAnimationObject(winrt::Microsoft::UI::Composition::IAnimationObject const& target, winrt::Microsoft::UI::Composition::ICompositionAnimationBase const& animation) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionPath) Create(winrt::Windows::Graphics::IGeometrySource2D const& source) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionPath) Path() const;
        WINRT_IMPL_AUTO(void) Path(winrt::Microsoft::UI::Composition::CompositionPath const& value) const;
    };
    ...
    struct consume_Microsoft_UI_Composition_ICompositionProjectedShadow
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionProjectedShadowCasterCollection) Casters() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionLight) LightSource() const;
        WINRT_IMPL_AUTO(void) LightSource(winrt::Microsoft::UI::Composition::CompositionLight const& value) const;
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionProjectedShadowReceiverUnorderedCollection) Receivers() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionBrush) Brush() const;
        WINRT_IMPL_AUTO(void) Brush(winrt::Microsoft::UI::Composition::CompositionBrush const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::Visual) CastingVisual() const;
        WINRT_IMPL_AUTO(void) CastingVisual(winrt::Microsoft::UI::Composition::Visual const& value) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(int32_t) Count() const;
        WINRT_IMPL_AUTO(void) InsertAbove(winrt::Microsoft::UI::Composition::CompositionProjectedShadowCaster const& newCaster, winrt::Microsoft::UI::Composition::CompositionProjectedShadowCaster const& reference) const;
        WINRT_IMPL_AUTO(void) InsertAtBottom(winrt::Microsoft::UI::Composition::CompositionProjectedShadowCaster const& newCaster) const;
        WINRT_IMPL_AUTO(void) InsertAtTop(winrt::Microsoft::UI::Composition::CompositionProjectedShadowCaster const& newCaster) const;
        WINRT_IMPL_AUTO(void) InsertBelow(winrt::Microsoft::UI::Composition::CompositionProjectedShadowCaster const& newCaster, winrt::Microsoft::UI::Composition::CompositionProjectedShadowCaster const& reference) const;
        WINRT_IMPL_AUTO(void) Remove(winrt::Microsoft::UI::Composition::CompositionProjectedShadowCaster const& caster) const;
        WINRT_IMPL_AUTO(void) RemoveAll() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::Visual) ReceivingVisual() const;
        WINRT_IMPL_AUTO(void) ReceivingVisual(winrt::Microsoft::UI::Composition::Visual const& value) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(void) Add(winrt::Microsoft::UI::Composition::CompositionProjectedShadowReceiver const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(int32_t) Count() const;
        WINRT_IMPL_AUTO(void) Remove(winrt::Microsoft::UI::Composition::CompositionProjectedShadowReceiver const& value) const;
        WINRT_IMPL_AUTO(void) RemoveAll() const;
    };
    ...
    struct consume_Microsoft_UI_Composition_ICompositionPropertySet
    {
        ...
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionGetValueStatus) TryGetColor(param::hstring const& propertyName, winrt::Windows::UI::Color& value) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionGetValueStatus) TryGetMatrix3x2(param::hstring const& propertyName, winrt::Windows::Foundation::Numerics::float3x2& value) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionGetValueStatus) TryGetMatrix4x4(param::hstring const& propertyName, winrt::Windows::Foundation::Numerics::float4x4& value) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionGetValueStatus) TryGetQuaternion(param::hstring const& propertyName, winrt::Windows::Foundation::Numerics::quaternion& value) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionGetValueStatus) TryGetScalar(param::hstring const& propertyName, float& value) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionGetValueStatus) TryGetVector2(param::hstring const& propertyName, winrt::Windows::Foundation::Numerics::float2& value) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionGetValueStatus) TryGetVector3(param::hstring const& propertyName, winrt::Windows::Foundation::Numerics::float3& value) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionGetValueStatus) TryGetVector4(param::hstring const& propertyName, winrt::Windows::Foundation::Numerics::float4& value) const;
    };
    ...
    struct consume_Microsoft_UI_Composition_ICompositionPropertySet2
    {
        ...
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionGetValueStatus) TryGetBoolean(param::hstring const& propertyName, bool& value) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionBrush) FillBrush() const;
        WINRT_IMPL_AUTO(void) FillBrush(winrt::Microsoft::UI::Composition::CompositionBrush const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionGeometry) Geometry() const;
        WINRT_IMPL_AUTO(void) Geometry(winrt::Microsoft::UI::Composition::CompositionGeometry const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) IsStrokeNonScaling() const;
        WINRT_IMPL_AUTO(void) IsStrokeNonScaling(bool value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionBrush) StrokeBrush() const;
        WINRT_IMPL_AUTO(void) StrokeBrush(winrt::Microsoft::UI::Composition::CompositionBrush const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionStrokeDashArray) StrokeDashArray() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionStrokeCap) StrokeDashCap() const;
        WINRT_IMPL_AUTO(void) StrokeDashCap(winrt::Microsoft::UI::Composition::CompositionStrokeCap const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) StrokeDashOffset() const;
        WINRT_IMPL_AUTO(void) StrokeDashOffset(float value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionStrokeCap) StrokeEndCap() const;
        WINRT_IMPL_AUTO(void) StrokeEndCap(winrt::Microsoft::UI::Composition::CompositionStrokeCap const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionStrokeLineJoin) StrokeLineJoin() const;
        WINRT_IMPL_AUTO(void) StrokeLineJoin(winrt::Microsoft::UI::Composition::CompositionStrokeLineJoin const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) StrokeMiterLimit() const;
        WINRT_IMPL_AUTO(void) StrokeMiterLimit(float value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionStrokeCap) StrokeStartCap() const;
        WINRT_IMPL_AUTO(void) StrokeStartCap(winrt::Microsoft::UI::Composition::CompositionStrokeCap const& value) const;
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionBitmapInterpolationMode) BitmapInterpolationMode() const;
        WINRT_IMPL_AUTO(void) BitmapInterpolationMode(winrt::Microsoft::UI::Composition::CompositionBitmapInterpolationMode const& value) const;
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionStretch) Stretch() const;
        WINRT_IMPL_AUTO(void) Stretch(winrt::Microsoft::UI::Composition::CompositionStretch const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::ICompositionSurface) Surface() const;
        WINRT_IMPL_AUTO(void) Surface(winrt::Microsoft::UI::Composition::ICompositionSurface const& value) const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::ICompositionSurface) GetRealSurface() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::Visual) SourceVisual() const;
        WINRT_IMPL_AUTO(void) SourceVisual(winrt::Microsoft::UI::Composition::Visual const& value) const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::ColorKeyFrameAnimation) CreateColorKeyFrameAnimation() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionColorBrush) CreateColorBrush() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionColorBrush) CreateColorBrush(winrt::Windows::UI::Color const& color) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::ContainerVisual) CreateContainerVisual() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CubicBezierEasingFunction) CreateCubicBezierEasingFunction(winrt::Windows::Foundation::Numerics::float2 const& controlPoint1, winrt::Windows::Foundation::Numerics::float2 const& controlPoint2) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionEffectFactory) CreateEffectFactory(winrt::Windows::Graphics::Effects::IGraphicsEffect const& graphicsEffect) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionEffectFactory) CreateEffectFactory(winrt::Windows::Graphics::Effects::IGraphicsEffect const& graphicsEffect, param::iterable<hstring> const& animatableProperties) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::ExpressionAnimation) CreateExpressionAnimation() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::ExpressionAnimation) CreateExpressionAnimation(param::hstring const& expression) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::InsetClip) CreateInsetClip() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::InsetClip) CreateInsetClip(float leftInset, float topInset, float rightInset, float bottomInset) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::LinearEasingFunction) CreateLinearEasingFunction() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionPropertySet) CreatePropertySet() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::QuaternionKeyFrameAnimation) CreateQuaternionKeyFrameAnimation() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::ScalarKeyFrameAnimation) CreateScalarKeyFrameAnimation() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionScopedBatch) CreateScopedBatch(winrt::Microsoft::UI::Composition::CompositionBatchTypes const& batchType) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::SpriteVisual) CreateSpriteVisual() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionSurfaceBrush) CreateSurfaceBrush() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionSurfaceBrush) CreateSurfaceBrush(winrt::Microsoft::UI::Composition::ICompositionSurface const& surface) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::Vector2KeyFrameAnimation) CreateVector2KeyFrameAnimation() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::Vector3KeyFrameAnimation) CreateVector3KeyFrameAnimation() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::Vector4KeyFrameAnimation) CreateVector4KeyFrameAnimation() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionCommitBatch) GetCommitBatch(winrt::Microsoft::UI::Composition::CompositionBatchTypes const& batchType) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::AmbientLight) CreateAmbientLight() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionAnimationGroup) CreateAnimationGroup() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionBackdropBrush) CreateBackdropBrush() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::DistantLight) CreateDistantLight() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::DropShadow) CreateDropShadow() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::ImplicitAnimationCollection) CreateImplicitAnimationCollection() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::LayerVisual) CreateLayerVisual() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionMaskBrush) CreateMaskBrush() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionNineGridBrush) CreateNineGridBrush() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::PointLight) CreatePointLight() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::SpotLight) CreateSpotLight() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::StepEasingFunction) CreateStepEasingFunction() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::StepEasingFunction) CreateStepEasingFunction(int32_t stepCount) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionColorGradientStop) CreateColorGradientStop() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionColorGradientStop) CreateColorGradientStop(float offset, winrt::Windows::UI::Color const& color) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionLinearGradientBrush) CreateLinearGradientBrush() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::SpringScalarNaturalMotionAnimation) CreateSpringScalarAnimation() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::SpringVector2NaturalMotionAnimation) CreateSpringVector2Animation() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::SpringVector3NaturalMotionAnimation) CreateSpringVector3Animation() const;
    };
    ...
    struct consume_Microsoft_UI_Composition_ICompositor5
    {
        ...
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::BounceScalarNaturalMotionAnimation) CreateBounceScalarAnimation() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::BounceVector2NaturalMotionAnimation) CreateBounceVector2Animation() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::BounceVector3NaturalMotionAnimation) CreateBounceVector3Animation() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionContainerShape) CreateContainerShape() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionEllipseGeometry) CreateEllipseGeometry() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionLineGeometry) CreateLineGeometry() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionPathGeometry) CreatePathGeometry() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionPathGeometry) CreatePathGeometry(winrt::Microsoft::UI::Composition::CompositionPath const& path) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::PathKeyFrameAnimation) CreatePathKeyFrameAnimation() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionRectangleGeometry) CreateRectangleGeometry() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionRoundedRectangleGeometry) CreateRoundedRectangleGeometry() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::ShapeVisual) CreateShapeVisual() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionSpriteShape) CreateSpriteShape() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionSpriteShape) CreateSpriteShape(winrt::Microsoft::UI::Composition::CompositionGeometry const& geometry) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionViewBox) CreateViewBox() const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionGeometricClip) CreateGeometricClip() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionGeometricClip) CreateGeometricClip(winrt::Microsoft::UI::Composition::CompositionGeometry const& geometry) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::RedirectVisual) CreateRedirectVisual() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::RedirectVisual) CreateRedirectVisual(winrt::Microsoft::UI::Composition::Visual const& source) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::BooleanKeyFrameAnimation) CreateBooleanKeyFrameAnimation() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Dispatching::DispatcherQueue) DispatcherQueue() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::AnimationPropertyInfo) CreateAnimationPropertyInfo() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::RectangleClip) CreateRectangleClip() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::RectangleClip) CreateRectangleClip(float left, float top, float right, float bottom) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::RectangleClip) CreateRectangleClip(float left, float top, float right, float bottom, winrt::Windows::Foundation::Numerics::float2 const& topLeftRadius, winrt::Windows::Foundation::Numerics::float2 const& topRightRadius, winrt::Windows::Foundation::Numerics::float2 const& bottomRightRadius, winrt::Windows::Foundation::Numerics::float2 const& bottomLeftRadius) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::AnimationController) CreateAnimationController() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionProjectedShadowCaster) CreateProjectedShadowCaster() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionProjectedShadow) CreateProjectedShadow() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionProjectedShadowReceiver) CreateProjectedShadowReceiver() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionRadialGradientBrush) CreateRadialGradientBrush() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionVisualSurface) CreateVisualSurface() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::VisualCollection) Children() const;
    };
    ...
    struct consume_Microsoft_UI_Composition_IDistantLight
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Color) Color() const;
        WINRT_IMPL_AUTO(void) Color(winrt::Windows::UI::Color const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::Visual) CoordinateSpace() const;
        WINRT_IMPL_AUTO(void) CoordinateSpace(winrt::Microsoft::UI::Composition::Visual const& value) const;
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionDropShadowSourcePolicy) SourcePolicy() const;
        WINRT_IMPL_AUTO(void) SourcePolicy(winrt::Microsoft::UI::Composition::CompositionDropShadowSourcePolicy const& value) const;
    };
    ...
    struct consume_Microsoft_UI_Composition_IKeyFrameAnimation
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::AnimationIterationBehavior) IterationBehavior() const;
        WINRT_IMPL_AUTO(void) IterationBehavior(winrt::Microsoft::UI::Composition::AnimationIterationBehavior const& value) const;
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::AnimationStopBehavior) StopBehavior() const;
        WINRT_IMPL_AUTO(void) StopBehavior(winrt::Microsoft::UI::Composition::AnimationStopBehavior const& value) const;
        WINRT_IMPL_AUTO(void) InsertExpressionKeyFrame(float normalizedProgressKey, param::hstring const& value) const;
        WINRT_IMPL_AUTO(void) InsertExpressionKeyFrame(float normalizedProgressKey, param::hstring const& value, winrt::Microsoft::UI::Composition::CompositionEasingFunction const& easingFunction) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::AnimationDirection) Direction() const;
        WINRT_IMPL_AUTO(void) Direction(winrt::Microsoft::UI::Composition::AnimationDirection const& value) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::AnimationDelayBehavior) DelayBehavior() const;
        WINRT_IMPL_AUTO(void) DelayBehavior(winrt::Microsoft::UI::Composition::AnimationDelayBehavior const& value) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionEffectBrush) Effect() const;
        WINRT_IMPL_AUTO(void) Effect(winrt::Microsoft::UI::Composition::CompositionEffectBrush const& value) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionShadow) Shadow() const;
        WINRT_IMPL_AUTO(void) Shadow(winrt::Microsoft::UI::Composition::CompositionShadow const& value) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(void) InsertKeyFrame(float normalizedProgressKey, winrt::Microsoft::UI::Composition::CompositionPath const& path) const;
        WINRT_IMPL_AUTO(void) InsertKeyFrame(float normalizedProgressKey, winrt::Microsoft::UI::Composition::CompositionPath const& path, winrt::Microsoft::UI::Composition::CompositionEasingFunction const& easingFunction) const;
    };
    ...
    struct consume_Microsoft_UI_Composition_IQuaternionKeyFrameAnimation
    {
        ...
        WINRT_IMPL_AUTO(void) InsertKeyFrame(float normalizedProgressKey, winrt::Windows::Foundation::Numerics::quaternion const& value, winrt::Microsoft::UI::Composition::CompositionEasingFunction const& easingFunction) const;
    };
    ...
    struct consume_Microsoft_UI_Composition_IRedirectVisual
    {
        ...
        WINRT_IMPL_AUTO(void) Source(winrt::Microsoft::UI::Composition::Visual const& value) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionGraphicsDevice) GraphicsDevice() const;
    };
    ...
    struct consume_Microsoft_UI_Composition_IScalarKeyFrameAnimation
    {
        ...
        WINRT_IMPL_AUTO(void) InsertKeyFrame(float normalizedProgressKey, float value, winrt::Microsoft::UI::Composition::CompositionEasingFunction const& easingFunction) const;
    };
    ...
    struct consume_Microsoft_UI_Composition_IVector2KeyFrameAnimation
    {
        ...
        WINRT_IMPL_AUTO(void) InsertKeyFrame(float normalizedProgressKey, winrt::Windows::Foundation::Numerics::float2 const& value, winrt::Microsoft::UI::Composition::CompositionEasingFunction const& easingFunction) const;
    };
    ...
    struct consume_Microsoft_UI_Composition_IVector3KeyFrameAnimation
    {
        ...
        WINRT_IMPL_AUTO(void) InsertKeyFrame(float normalizedProgressKey, winrt::Windows::Foundation::Numerics::float3 const& value, winrt::Microsoft::UI::Composition::CompositionEasingFunction const& easingFunction) const;
    };
    ...
    struct consume_Microsoft_UI_Composition_IVector4KeyFrameAnimation
    {
        ...
        WINRT_IMPL_AUTO(void) InsertKeyFrame(float normalizedProgressKey, winrt::Windows::Foundation::Numerics::float4 const& value, winrt::Microsoft::UI::Composition::CompositionEasingFunction const& easingFunction) const;
    };
    ...
    struct consume_Microsoft_UI_Composition_IVisual
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Numerics::float2) AnchorPoint() const;
        WINRT_IMPL_AUTO(void) AnchorPoint(winrt::Windows::Foundation::Numerics::float2 const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionBackfaceVisibility) BackfaceVisibility() const;
        WINRT_IMPL_AUTO(void) BackfaceVisibility(winrt::Microsoft::UI::Composition::CompositionBackfaceVisibility const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionBorderMode) BorderMode() const;
        WINRT_IMPL_AUTO(void) BorderMode(winrt::Microsoft::UI::Composition::CompositionBorderMode const& value) const;
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionClip) Clip() const;
        WINRT_IMPL_AUTO(void) Clip(winrt::Microsoft::UI::Composition::CompositionClip const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::CompositionCompositeMode) CompositeMode() const;
        WINRT_IMPL_AUTO(void) CompositeMode(winrt::Microsoft::UI::Composition::CompositionCompositeMode const& value) const;
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::ContainerVisual) Parent() const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) RotationAngle() const;
        WINRT_IMPL_AUTO(void) RotationAngle(float value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(float) RotationAngleInDegrees() const;
        WINRT_IMPL_AUTO(void) RotationAngleInDegrees(float value) const;
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::Visual) ParentForTransform() const;
        WINRT_IMPL_AUTO(void) ParentForTransform(winrt::Microsoft::UI::Composition::Visual const& value) const;
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(int32_t) Count() const;
        WINRT_IMPL_AUTO(void) InsertAbove(winrt::Microsoft::UI::Composition::Visual const& newChild, winrt::Microsoft::UI::Composition::Visual const& sibling) const;
        WINRT_IMPL_AUTO(void) InsertAtBottom(winrt::Microsoft::UI::Composition::Visual const& newChild) const;
        WINRT_IMPL_AUTO(void) InsertAtTop(winrt::Microsoft::UI::Composition::Visual const& newChild) const;
        WINRT_IMPL_AUTO(void) InsertBelow(winrt::Microsoft::UI::Composition::Visual const& newChild, winrt::Microsoft::UI::Composition::Visual const& sibling) const;
        WINRT_IMPL_AUTO(void) Remove(winrt::Microsoft::UI::Composition::Visual const& child) const;
        WINRT_IMPL_AUTO(void) RemoveAll() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::Visual) GetVisualInternal() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(int32_t) Count() const;
        WINRT_IMPL_AUTO(void) Add(winrt::Microsoft::UI::Composition::Visual const& newVisual) const;
        WINRT_IMPL_AUTO(void) Remove(winrt::Microsoft::UI::Composition::Visual const& visual) const;
        WINRT_IMPL_AUTO(void) RemoveAll() const;
    };
