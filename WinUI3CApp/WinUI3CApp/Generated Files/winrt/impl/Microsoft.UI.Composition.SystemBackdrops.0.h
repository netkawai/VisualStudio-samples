...
namespace winrt::impl
{
    ...
    {
        WINRT_IMPL_AUTO(void) ResetProperties() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::SystemBackdrops::MicaKind) Kind() const;
        WINRT_IMPL_AUTO(void) Kind(winrt::Microsoft::UI::Composition::SystemBackdrops::MicaKind const& value) const;
        WINRT_IMPL_AUTO(void) ResetProperties() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::IReference<winrt::Windows::UI::Color>) HighContrastBackgroundColor() const;
        WINRT_IMPL_AUTO(void) HighContrastBackgroundColor(winrt::Windows::Foundation::IReference<winrt::Windows::UI::Color> const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) IsHighContrast() const;
        WINRT_IMPL_AUTO(void) IsHighContrast(bool value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) IsInputActive() const;
        WINRT_IMPL_AUTO(void) IsInputActive(bool value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::SystemBackdrops::SystemBackdropTheme) Theme() const;
        WINRT_IMPL_AUTO(void) Theme(winrt::Microsoft::UI::Composition::SystemBackdrops::SystemBackdropTheme const& value) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::SystemBackdrops::SystemBackdropState) State() const;
        WINRT_IMPL_AUTO(bool) AddSystemBackdropTarget(winrt::Microsoft::UI::Composition::ICompositionSupportsSystemBackdrop const& systemBackdropTarget) const;
        WINRT_IMPL_AUTO(void) RemoveAllSystemBackdropTargets() const;
        WINRT_IMPL_AUTO(bool) RemoveSystemBackdropTarget(winrt::Microsoft::UI::Composition::ICompositionSupportsSystemBackdrop const& systemBackdropTarget) const;
        WINRT_IMPL_AUTO(void) SetSystemBackdropConfiguration(winrt::Microsoft::UI::Composition::SystemBackdrops::SystemBackdropConfiguration const& configuration) const;
        WINRT_IMPL_AUTO(winrt::event_token) StateChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Composition::SystemBackdrops::ISystemBackdropControllerWithTargets, winrt::Windows::Foundation::IInspectable> const& handler) const;
        ...
        [[nodiscard]] StateChanged_revoker StateChanged(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Composition::SystemBackdrops::ISystemBackdropControllerWithTargets, winrt::Windows::Foundation::IInspectable> const& handler) const;
