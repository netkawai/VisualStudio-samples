...
WINRT_EXPORT namespace winrt::Microsoft::UI::Xaml::Navigation
{
    ...
    struct __declspec(empty_bases) FrameNavigationOptions : winrt::Microsoft::UI::Xaml::Navigation::IFrameNavigationOptions
    {
    ...
    struct __declspec(empty_bases) NavigatingCancelEventArgs : winrt::Microsoft::UI::Xaml::Navigation::INavigatingCancelEventArgs
    {
    ...
    struct __declspec(empty_bases) NavigationEventArgs : winrt::Microsoft::UI::Xaml::Navigation::INavigationEventArgs
    {
    ...
    struct __declspec(empty_bases) NavigationFailedEventArgs : winrt::Microsoft::UI::Xaml::Navigation::INavigationFailedEventArgs
    {
    ...
    struct __declspec(empty_bases) PageStackEntry : winrt::Microsoft::UI::Xaml::Navigation::IPageStackEntry,
