...
namespace winrt::impl
{
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) Contrast() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) Custom() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) DeviceFamily() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) HomeRegion() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) Language() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) LayoutDirection() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) Scale() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) TargetSize() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) Theme() const;
    };
    ...
    struct consume_Microsoft_Windows_ApplicationModel_Resources_IResourceCandidate
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(com_array<uint8_t>) ValueAsBytes() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Windows::ApplicationModel::Resources::ResourceCandidateKind) Kind() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IMapView<hstring, hstring>) QualifierValues() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::Windows::ApplicationModel::Resources::ResourceCandidate) CreateInstance(winrt::Microsoft::Windows::ApplicationModel::Resources::ResourceCandidateKind const& kind, param::hstring const& data) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Windows::ApplicationModel::Resources::ResourceCandidate) CreateInstance2(array_view<uint8_t const> data) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IMap<hstring, hstring>) QualifierValues() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(hstring) GetString(param::hstring const& resourceId) const;
        WINRT_IMPL_AUTO(hstring) GetStringForUri(winrt::Windows::Foundation::Uri const& resourceUri) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::Windows::ApplicationModel::Resources::ResourceLoader) CreateInstance(param::hstring const& fileName) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Windows::ApplicationModel::Resources::ResourceLoader) CreateInstance2(param::hstring const& fileName, param::hstring const& resourceMap) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(hstring) GetDefaultResourceFilePath() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Windows::ApplicationModel::Resources::ResourceMap) MainResourceMap() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Windows::ApplicationModel::Resources::ResourceContext) CreateResourceContext() const;
        WINRT_IMPL_AUTO(winrt::event_token) ResourceNotFound(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Windows::ApplicationModel::Resources::ResourceManager, winrt::Microsoft::Windows::ApplicationModel::Resources::ResourceNotFoundEventArgs> const& handler) const;
        ...
        [[nodiscard]] ResourceNotFound_revoker ResourceNotFound(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Windows::ApplicationModel::Resources::ResourceManager, winrt::Microsoft::Windows::ApplicationModel::Resources::ResourceNotFoundEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) ResourceNotFound(winrt::event_token const& token) const noexcept;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::Windows::ApplicationModel::Resources::ResourceManager) CreateInstance(param::hstring const& fileName) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(uint32_t) ResourceCount() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Windows::ApplicationModel::Resources::ResourceMap) GetSubtree(param::hstring const& reference) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Windows::ApplicationModel::Resources::ResourceMap) TryGetSubtree(param::hstring const& reference) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Windows::ApplicationModel::Resources::ResourceCandidate) GetValue(param::hstring const& resource) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Windows::ApplicationModel::Resources::ResourceCandidate) GetValue(param::hstring const& resource, winrt::Microsoft::Windows::ApplicationModel::Resources::ResourceContext const& context) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IKeyValuePair<hstring, winrt::Microsoft::Windows::ApplicationModel::Resources::ResourceCandidate>) GetValueByIndex(uint32_t index) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IKeyValuePair<hstring, winrt::Microsoft::Windows::ApplicationModel::Resources::ResourceCandidate>) GetValueByIndex(uint32_t index, winrt::Microsoft::Windows::ApplicationModel::Resources::ResourceContext const& context) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Windows::ApplicationModel::Resources::ResourceCandidate) TryGetValue(param::hstring const& resource) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Windows::ApplicationModel::Resources::ResourceCandidate) TryGetValue(param::hstring const& resource, winrt::Microsoft::Windows::ApplicationModel::Resources::ResourceContext const& context) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Windows::ApplicationModel::Resources::ResourceContext) Context() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) Name() const;
        WINRT_IMPL_AUTO(void) SetResolvedCandidate(winrt::Microsoft::Windows::ApplicationModel::Resources::ResourceCandidate const& candidate) const;
    };
