...
{
    struct __declspec(empty_bases) IAppNotification :
    ...
    struct __declspec(empty_bases) IAppNotificationActivatedEventArgs :
        winrt::Windows::Foundation::IInspectable,
    ...
    struct __declspec(empty_bases) IAppNotificationFactory :
        winrt::Windows::Foundation::IInspectable,
    ...
    struct __declspec(empty_bases) IAppNotificationManager :
        winrt::Windows::Foundation::IInspectable,
    ...
    struct __declspec(empty_bases) IAppNotificationManagerStatics :
        winrt::Windows::Foundation::IInspectable,
    ...
    struct __declspec(empty_bases) IAppNotificationProgressData :
        winrt::Windows::Foundation::IInspectable,
    ...
    struct __declspec(empty_bases) IAppNotificationProgressDataFactory :
        winrt::Windows::Foundation::IInspectable,
