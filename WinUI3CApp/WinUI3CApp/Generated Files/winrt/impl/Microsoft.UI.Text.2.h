...
{
    struct __declspec(empty_bases) FontWeights : winrt::Microsoft::UI::Text::IFontWeights
    {
    ...
    struct __declspec(empty_bases) RichEditTextDocument : winrt::Microsoft::UI::Text::ITextDocument
    {
    ...
    struct __declspec(empty_bases) RichEditTextRange : winrt::Microsoft::UI::Text::ITextRange
    {
