...
WINRT_EXPORT namespace winrt::Microsoft::UI::Xaml::Printing
{
    ...
    struct __declspec(empty_bases) AddPagesEventArgs : winrt::Microsoft::UI::Xaml::Printing::IAddPagesEventArgs
    {
    ...
    struct __declspec(empty_bases) GetPreviewPageEventArgs : winrt::Microsoft::UI::Xaml::Printing::IGetPreviewPageEventArgs
    {
    ...
    struct __declspec(empty_bases) PaginateEventArgs : winrt::Microsoft::UI::Xaml::Printing::IPaginateEventArgs
    {
    ...
    struct __declspec(empty_bases) PrintDocument : winrt::Microsoft::UI::Xaml::Printing::IPrintDocument,
