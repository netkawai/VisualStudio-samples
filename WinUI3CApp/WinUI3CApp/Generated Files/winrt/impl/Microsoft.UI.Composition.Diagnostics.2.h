...
{
    struct __declspec(empty_bases) CompositionDebugHeatMaps : winrt::Microsoft::UI::Composition::Diagnostics::ICompositionDebugHeatMaps
    {
    ...
    struct __declspec(empty_bases) CompositionDebugSettings : winrt::Microsoft::UI::Composition::Diagnostics::ICompositionDebugSettings
    {
