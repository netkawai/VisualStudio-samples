...
namespace winrt::impl
{
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Security::Cryptography::Certificates::Certificate) ToCertificate() const;
    };
    ...
    struct consume_Microsoft_Web_WebView2_Core_ICoreWebView2BasicAuthenticationRequestedEventArgs
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) Challenge() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Web::WebView2::Core::CoreWebView2BasicAuthenticationResponse) Response() const;
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Web::WebView2::Core::CoreWebView2BrowserProcessExitKind) BrowserProcessExitKind() const;
        [[nodiscard]] WINRT_IMPL_AUTO(uint32_t) BrowserProcessId() const;
    };
    ...
    struct consume_Microsoft_Web_WebView2_Core_ICoreWebView2ClientCertificate
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(double) ValidFrom() const;
        [[nodiscard]] WINRT_IMPL_AUTO(double) ValidTo() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) DerEncodedSerialNumber() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) DisplayName() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<hstring>) PemEncodedIssuerCertificateChain() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Web::WebView2::Core::CoreWebView2ClientCertificateKind) Kind() const;
        WINRT_IMPL_AUTO(hstring) ToPemEncoding() const;
    };
    ...
    struct consume_Microsoft_Web_WebView2_Core_ICoreWebView2ClientCertificateRequestedEventArgs
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(bool) IsProxy() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<hstring>) AllowedCertificateAuthorities() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<winrt::Microsoft::Web::WebView2::Core::CoreWebView2ClientCertificate>) MutuallyTrustedCertificates() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Web::WebView2::Core::CoreWebView2ClientCertificate) SelectedCertificate() const;
        WINRT_IMPL_AUTO(void) SelectedCertificate(winrt::Microsoft::Web::WebView2::Core::CoreWebView2ClientCertificate const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) Cancel() const;
        WINRT_IMPL_AUTO(void) Cancel(bool value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) Handled() const;
        WINRT_IMPL_AUTO(void) Handled(bool value) const;
    ...
    struct consume_Microsoft_Web_WebView2_Core_ICoreWebView2ContextMenuItem
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(int32_t) CommandId() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) ShortcutKeyDescription() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Storage::Streams::IRandomAccessStream) Icon() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Web::WebView2::Core::CoreWebView2ContextMenuItemKind) Kind() const;
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVector<winrt::Microsoft::Web::WebView2::Core::CoreWebView2ContextMenuItem>) Children() const;
        WINRT_IMPL_AUTO(winrt::event_token) CustomItemSelected(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2ContextMenuItem, winrt::Windows::Foundation::IInspectable> const& handler) const;
        ...
        [[nodiscard]] CustomItemSelected_revoker CustomItemSelected(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2ContextMenuItem, winrt::Windows::Foundation::IInspectable> const& handler) const;
        WINRT_IMPL_AUTO(void) CustomItemSelected(winrt::event_token const& token) const noexcept;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVector<winrt::Microsoft::Web::WebView2::Core::CoreWebView2ContextMenuItem>) MenuItems() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Web::WebView2::Core::CoreWebView2ContextMenuTarget) ContextMenuTarget() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Point) Location() const;
        [[nodiscard]] WINRT_IMPL_AUTO(int32_t) SelectedCommandId() const;
        WINRT_IMPL_AUTO(void) SelectedCommandId(int32_t value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) Handled() const;
        WINRT_IMPL_AUTO(void) Handled(bool value) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Deferral) GetDeferral() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Web::WebView2::Core::CoreWebView2ContextMenuTargetKind) Kind() const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) IsEditable() const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) IsRequestedForMainFrame() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) PageUri() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) FrameUri() const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) HasLinkUri() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) LinkUri() const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) HasLinkText() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) LinkText() const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) HasSourceUri() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) SourceUri() const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) HasSelection() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) SelectionText() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(bool) AllowExternalDrop() const;
        WINRT_IMPL_AUTO(void) AllowExternalDrop(bool value) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Foundation::Collections::IVectorView<winrt::Microsoft::Web::WebView2::Core::CoreWebView2Cookie>>) GetCookiesAsync(param::hstring const& uri) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IInspectable) WrapNamedObject(param::hstring const& name, winrt::Microsoft::Web::WebView2::Core::ICoreWebView2DispatchAdapter const& adapter) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IInspectable) WrapObject(winrt::Windows::Foundation::IInspectable const& unwrapped, winrt::Microsoft::Web::WebView2::Core::ICoreWebView2DispatchAdapter const& adapter) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IInspectable) UnwrapObject(winrt::Windows::Foundation::IInspectable const& wrapped) const;
        WINRT_IMPL_AUTO(void) Clean() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) Uri() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) ContentDisposition() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) MimeType() const;
        [[nodiscard]] WINRT_IMPL_AUTO(int64_t) TotalBytesToReceive() const;
        [[nodiscard]] WINRT_IMPL_AUTO(int64_t) BytesReceived() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) EstimatedEndTime() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) ResultFilePath() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Web::WebView2::Core::CoreWebView2DownloadState) State() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Web::WebView2::Core::CoreWebView2DownloadInterruptReason) InterruptReason() const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) CanResume() const;
        WINRT_IMPL_AUTO(winrt::event_token) BytesReceivedChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2DownloadOperation, winrt::Windows::Foundation::IInspectable> const& handler) const;
        ...
        [[nodiscard]] BytesReceivedChanged_revoker BytesReceivedChanged(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2DownloadOperation, winrt::Windows::Foundation::IInspectable> const& handler) const;
        WINRT_IMPL_AUTO(void) BytesReceivedChanged(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) EstimatedEndTimeChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2DownloadOperation, winrt::Windows::Foundation::IInspectable> const& handler) const;
        ...
        [[nodiscard]] EstimatedEndTimeChanged_revoker EstimatedEndTimeChanged(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2DownloadOperation, winrt::Windows::Foundation::IInspectable> const& handler) const;
        WINRT_IMPL_AUTO(void) EstimatedEndTimeChanged(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) StateChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2DownloadOperation, winrt::Windows::Foundation::IInspectable> const& handler) const;
        ...
        [[nodiscard]] StateChanged_revoker StateChanged(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2DownloadOperation, winrt::Windows::Foundation::IInspectable> const& handler) const;
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Web::WebView2::Core::CoreWebView2DownloadOperation) DownloadOperation() const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) Cancel() const;
        WINRT_IMPL_AUTO(void) Cancel(bool value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) ResultFilePath() const;
        WINRT_IMPL_AUTO(void) ResultFilePath(param::hstring const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) Handled() const;
        WINRT_IMPL_AUTO(void) Handled(bool value) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Deferral) GetDeferral() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::event_token) BrowserProcessExited(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2Environment, winrt::Microsoft::Web::WebView2::Core::CoreWebView2BrowserProcessExitedEventArgs> const& handler) const;
        ...
        [[nodiscard]] BrowserProcessExited_revoker BrowserProcessExited(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2Environment, winrt::Microsoft::Web::WebView2::Core::CoreWebView2BrowserProcessExitedEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) BrowserProcessExited(winrt::event_token const& token) const noexcept;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::Web::WebView2::Core::CoreWebView2PrintSettings) CreatePrintSettings() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) UserDataFolder() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::event_token) ProcessInfosChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2Environment, winrt::Windows::Foundation::IInspectable> const& handler) const;
        ...
        [[nodiscard]] ProcessInfosChanged_revoker ProcessInfosChanged(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2Environment, winrt::Windows::Foundation::IInspectable> const& handler) const;
        WINRT_IMPL_AUTO(void) ProcessInfosChanged(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<winrt::Microsoft::Web::WebView2::Core::CoreWebView2ProcessInfo>) GetProcessInfos() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::Web::WebView2::Core::CoreWebView2ContextMenuItem) CreateContextMenuItem(param::hstring const& Label, winrt::Windows::Storage::Streams::IRandomAccessStream const& iconStream, winrt::Microsoft::Web::WebView2::Core::CoreWebView2ContextMenuItemKind const& Kind) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(bool) ExclusiveUserDataFolderAccess() const;
        WINRT_IMPL_AUTO(void) ExclusiveUserDataFolderAccess(bool value) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) Name() const;
        WINRT_IMPL_AUTO(winrt::event_token) NameChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2Frame, winrt::Windows::Foundation::IInspectable> const& handler) const;
        ...
        [[nodiscard]] NameChanged_revoker NameChanged(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2Frame, winrt::Windows::Foundation::IInspectable> const& handler) const;
        WINRT_IMPL_AUTO(void) NameChanged(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) Destroyed(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2Frame, winrt::Windows::Foundation::IInspectable> const& handler) const;
        ...
        [[nodiscard]] Destroyed_revoker Destroyed(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2Frame, winrt::Windows::Foundation::IInspectable> const& handler) const;
        WINRT_IMPL_AUTO(void) Destroyed(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(void) RemoveHostObjectFromScript(param::hstring const& name) const;
        WINRT_IMPL_AUTO(int32_t) IsDestroyed() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::event_token) NavigationStarting(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2Frame, winrt::Microsoft::Web::WebView2::Core::CoreWebView2NavigationStartingEventArgs> const& handler) const;
        ...
        [[nodiscard]] NavigationStarting_revoker NavigationStarting(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2Frame, winrt::Microsoft::Web::WebView2::Core::CoreWebView2NavigationStartingEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) NavigationStarting(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) ContentLoading(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2Frame, winrt::Microsoft::Web::WebView2::Core::CoreWebView2ContentLoadingEventArgs> const& handler) const;
        ...
        [[nodiscard]] ContentLoading_revoker ContentLoading(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2Frame, winrt::Microsoft::Web::WebView2::Core::CoreWebView2ContentLoadingEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) ContentLoading(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) NavigationCompleted(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2Frame, winrt::Microsoft::Web::WebView2::Core::CoreWebView2NavigationCompletedEventArgs> const& handler) const;
        ...
        [[nodiscard]] NavigationCompleted_revoker NavigationCompleted(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2Frame, winrt::Microsoft::Web::WebView2::Core::CoreWebView2NavigationCompletedEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) NavigationCompleted(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) DOMContentLoaded(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2Frame, winrt::Microsoft::Web::WebView2::Core::CoreWebView2DOMContentLoadedEventArgs> const& handler) const;
        ...
        [[nodiscard]] DOMContentLoaded_revoker DOMContentLoaded(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2Frame, winrt::Microsoft::Web::WebView2::Core::CoreWebView2DOMContentLoadedEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) DOMContentLoaded(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) WebMessageReceived(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2Frame, winrt::Microsoft::Web::WebView2::Core::CoreWebView2WebMessageReceivedEventArgs> const& handler) const;
        ...
        [[nodiscard]] WebMessageReceived_revoker WebMessageReceived(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2Frame, winrt::Microsoft::Web::WebView2::Core::CoreWebView2WebMessageReceivedEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) WebMessageReceived(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<hstring>) ExecuteScriptAsync(param::hstring const& javaScript) const;
        WINRT_IMPL_AUTO(void) PostWebMessageAsJson(param::hstring const& webMessageAsJson) const;
        WINRT_IMPL_AUTO(void) PostWebMessageAsString(param::hstring const& webMessageAsString) const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::event_token) PermissionRequested(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2Frame, winrt::Microsoft::Web::WebView2::Core::CoreWebView2PermissionRequestedEventArgs> const& handler) const;
        ...
        [[nodiscard]] PermissionRequested_revoker PermissionRequested(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2Frame, winrt::Microsoft::Web::WebView2::Core::CoreWebView2PermissionRequestedEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) PermissionRequested(winrt::event_token const& token) const noexcept;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Web::WebView2::Core::CoreWebView2Frame) Frame() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) AdditionalAllowedFrameAncestors() const;
        WINRT_IMPL_AUTO(void) AdditionalAllowedFrameAncestors(param::hstring const& value) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Web::WebView2::Core::CoreWebView2PrintOrientation) Orientation() const;
        WINRT_IMPL_AUTO(void) Orientation(winrt::Microsoft::Web::WebView2::Core::CoreWebView2PrintOrientation const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(double) ScaleFactor() const;
        WINRT_IMPL_AUTO(void) ScaleFactor(double value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(double) PageWidth() const;
        WINRT_IMPL_AUTO(void) PageWidth(double value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(double) PageHeight() const;
        WINRT_IMPL_AUTO(void) PageHeight(double value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(double) MarginTop() const;
        WINRT_IMPL_AUTO(void) MarginTop(double value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(double) MarginBottom() const;
        WINRT_IMPL_AUTO(void) MarginBottom(double value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(double) MarginLeft() const;
        WINRT_IMPL_AUTO(void) MarginLeft(double value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(double) MarginRight() const;
        WINRT_IMPL_AUTO(void) MarginRight(double value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) ShouldPrintBackgrounds() const;
        WINRT_IMPL_AUTO(void) ShouldPrintBackgrounds(bool value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) ShouldPrintSelectionOnly() const;
        WINRT_IMPL_AUTO(void) ShouldPrintSelectionOnly(bool value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) ShouldPrintHeaderAndFooter() const;
        WINRT_IMPL_AUTO(void) ShouldPrintHeaderAndFooter(bool value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) HeaderTitle() const;
        WINRT_IMPL_AUTO(void) HeaderTitle(param::hstring const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) FooterUri() const;
        WINRT_IMPL_AUTO(void) FooterUri(param::hstring const& value) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Web::WebView2::Core::CoreWebView2ProcessFailedReason) Reason() const;
        [[nodiscard]] WINRT_IMPL_AUTO(int32_t) ExitCode() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) ProcessDescription() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<winrt::Microsoft::Web::WebView2::Core::CoreWebView2FrameInfo>) FrameInfosForFailedProcess() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(int32_t) ProcessId() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Web::WebView2::Core::CoreWebView2ProcessKind) Kind() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) UserAgent() const;
        WINRT_IMPL_AUTO(void) UserAgent(param::hstring const& value) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(bool) AreBrowserAcceleratorKeysEnabled() const;
        WINRT_IMPL_AUTO(void) AreBrowserAcceleratorKeysEnabled(bool value) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(bool) IsPasswordAutosaveEnabled() const;
        WINRT_IMPL_AUTO(void) IsPasswordAutosaveEnabled(bool value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) IsGeneralAutofillEnabled() const;
        WINRT_IMPL_AUTO(void) IsGeneralAutofillEnabled(bool value) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(bool) IsPinchZoomEnabled() const;
        WINRT_IMPL_AUTO(void) IsPinchZoomEnabled(bool value) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(bool) IsSwipeNavigationEnabled() const;
        WINRT_IMPL_AUTO(void) IsSwipeNavigationEnabled(bool value) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Web::WebView2::Core::CoreWebView2PdfToolbarItems) HiddenPdfToolbarItems() const;
        WINRT_IMPL_AUTO(void) HiddenPdfToolbarItems(winrt::Microsoft::Web::WebView2::Core::CoreWebView2PdfToolbarItems const& value) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Web::WebView2::Core::ICoreWebView2DispatchAdapter) HostObjectDispatchAdapter() const;
        WINRT_IMPL_AUTO(void) HostObjectDispatchAdapter(winrt::Microsoft::Web::WebView2::Core::ICoreWebView2DispatchAdapter const& value) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::event_token) BasicAuthenticationRequested(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2, winrt::Microsoft::Web::WebView2::Core::CoreWebView2BasicAuthenticationRequestedEventArgs> const& handler) const;
        ...
        [[nodiscard]] BasicAuthenticationRequested_revoker BasicAuthenticationRequested(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2, winrt::Microsoft::Web::WebView2::Core::CoreWebView2BasicAuthenticationRequestedEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) BasicAuthenticationRequested(winrt::event_token const& token) const noexcept;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::event_token) ContextMenuRequested(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2, winrt::Microsoft::Web::WebView2::Core::CoreWebView2ContextMenuRequestedEventArgs> const& handler) const;
        ...
        [[nodiscard]] ContextMenuRequested_revoker ContextMenuRequested(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2, winrt::Microsoft::Web::WebView2::Core::CoreWebView2ContextMenuRequestedEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) ContextMenuRequested(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<hstring>) CallDevToolsProtocolMethodForSessionAsync(param::hstring const& sessionId, param::hstring const& methodName, param::hstring const& parametersAsJson) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) StatusBarText() const;
        WINRT_IMPL_AUTO(winrt::event_token) StatusBarTextChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2, winrt::Windows::Foundation::IInspectable> const& handler) const;
        ...
        [[nodiscard]] StatusBarTextChanged_revoker StatusBarTextChanged(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2, winrt::Windows::Foundation::IInspectable> const& handler) const;
        WINRT_IMPL_AUTO(void) StatusBarTextChanged(winrt::event_token const& token) const noexcept;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::event_token) FrameCreated(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2, winrt::Microsoft::Web::WebView2::Core::CoreWebView2FrameCreatedEventArgs> const& handler) const;
        ...
        [[nodiscard]] FrameCreated_revoker FrameCreated(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2, winrt::Microsoft::Web::WebView2::Core::CoreWebView2FrameCreatedEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) FrameCreated(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) DownloadStarting(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2, winrt::Microsoft::Web::WebView2::Core::CoreWebView2DownloadStartingEventArgs> const& handler) const;
        ...
        [[nodiscard]] DownloadStarting_revoker DownloadStarting(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2, winrt::Microsoft::Web::WebView2::Core::CoreWebView2DownloadStartingEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) DownloadStarting(winrt::event_token const& token) const noexcept;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::event_token) ClientCertificateRequested(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2, winrt::Microsoft::Web::WebView2::Core::CoreWebView2ClientCertificateRequestedEventArgs> const& handler) const;
        ...
        [[nodiscard]] ClientCertificateRequested_revoker ClientCertificateRequested(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2, winrt::Microsoft::Web::WebView2::Core::CoreWebView2ClientCertificateRequestedEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) ClientCertificateRequested(winrt::event_token const& token) const noexcept;
    };
    ...
    {
        WINRT_IMPL_AUTO(void) OpenTaskManagerWindow() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<bool>) PrintToPdfAsync(param::hstring const& ResultFilePath, winrt::Microsoft::Web::WebView2::Core::CoreWebView2PrintSettings const& printSettings) const;
    };
    ...
    struct consume_Microsoft_Web_WebView2_Core_ICoreWebView2_8
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(bool) IsDocumentPlayingAudio() const;
        WINRT_IMPL_AUTO(winrt::event_token) IsMutedChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2, winrt::Windows::Foundation::IInspectable> const& handler) const;
        ...
        [[nodiscard]] IsMutedChanged_revoker IsMutedChanged(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2, winrt::Windows::Foundation::IInspectable> const& handler) const;
        WINRT_IMPL_AUTO(void) IsMutedChanged(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) IsDocumentPlayingAudioChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2, winrt::Windows::Foundation::IInspectable> const& handler) const;
        ...
        [[nodiscard]] IsDocumentPlayingAudioChanged_revoker IsDocumentPlayingAudioChanged(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2, winrt::Windows::Foundation::IInspectable> const& handler) const;
        WINRT_IMPL_AUTO(void) IsDocumentPlayingAudioChanged(winrt::event_token const& token) const noexcept;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(bool) IsDefaultDownloadDialogOpen() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Web::WebView2::Core::CoreWebView2DefaultDownloadDialogCornerAlignment) DefaultDownloadDialogCornerAlignment() const;
        WINRT_IMPL_AUTO(void) DefaultDownloadDialogCornerAlignment(winrt::Microsoft::Web::WebView2::Core::CoreWebView2DefaultDownloadDialogCornerAlignment const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Point) DefaultDownloadDialogMargin() const;
        WINRT_IMPL_AUTO(void) DefaultDownloadDialogMargin(winrt::Windows::Foundation::Point const& value) const;
        WINRT_IMPL_AUTO(winrt::event_token) IsDefaultDownloadDialogOpenChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2, winrt::Windows::Foundation::IInspectable> const& handler) const;
        ...
        [[nodiscard]] IsDefaultDownloadDialogOpenChanged_revoker IsDefaultDownloadDialogOpenChanged(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Web::WebView2::Core::CoreWebView2, winrt::Windows::Foundation::IInspectable> const& handler) const;
        WINRT_IMPL_AUTO(void) IsDefaultDownloadDialogOpenChanged(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(void) OpenDefaultDownloadDialog() const;
        WINRT_IMPL_AUTO(void) CloseDefaultDownloadDialog() const;
    };
