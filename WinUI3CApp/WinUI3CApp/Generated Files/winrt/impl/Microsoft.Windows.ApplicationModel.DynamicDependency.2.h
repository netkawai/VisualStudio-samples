...
WINRT_EXPORT namespace winrt::Microsoft::Windows::ApplicationModel::DynamicDependency
{
    ...
    struct __declspec(empty_bases) AddPackageDependencyOptions : winrt::Microsoft::Windows::ApplicationModel::DynamicDependency::IAddPackageDependencyOptions
    {
    ...
    struct __declspec(empty_bases) CreatePackageDependencyOptions : winrt::Microsoft::Windows::ApplicationModel::DynamicDependency::ICreatePackageDependencyOptions
    {
    ...
    struct __declspec(empty_bases) PackageDependency : winrt::Microsoft::Windows::ApplicationModel::DynamicDependency::IPackageDependency
    {
    ...
    struct __declspec(empty_bases) PackageDependencyContext : winrt::Microsoft::Windows::ApplicationModel::DynamicDependency::IPackageDependencyContext
    {
