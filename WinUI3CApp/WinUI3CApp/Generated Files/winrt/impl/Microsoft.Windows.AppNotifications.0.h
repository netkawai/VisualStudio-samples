...
namespace winrt::impl
{
    ...
    struct consume_Microsoft_Windows_AppNotifications_IAppNotification
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) Payload() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Windows::AppNotifications::AppNotificationProgressData) Progress() const;
        WINRT_IMPL_AUTO(void) Progress(winrt::Microsoft::Windows::AppNotifications::AppNotificationProgressData const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::DateTime) Expiration() const;
        WINRT_IMPL_AUTO(void) Expiration(winrt::Windows::Foundation::DateTime const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) ExpiresOnReboot() const;
        WINRT_IMPL_AUTO(void) ExpiresOnReboot(bool value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Windows::AppNotifications::AppNotificationPriority) Priority() const;
        WINRT_IMPL_AUTO(void) Priority(winrt::Microsoft::Windows::AppNotifications::AppNotificationPriority const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) SuppressDisplay() const;
        WINRT_IMPL_AUTO(void) SuppressDisplay(bool value) const;
    };
    ...
    struct consume_Microsoft_Windows_AppNotifications_IAppNotificationActivatedEventArgs
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IMap<hstring, hstring>) UserInput() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::Windows::AppNotifications::AppNotification) CreateInstance(param::hstring const& payload) const;
    };
    ...
    struct consume_Microsoft_Windows_AppNotifications_IAppNotificationManager
    {
        ...
        WINRT_IMPL_AUTO(winrt::event_token) NotificationInvoked(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Windows::AppNotifications::AppNotificationManager, winrt::Microsoft::Windows::AppNotifications::AppNotificationActivatedEventArgs> const& handler) const;
        ...
        [[nodiscard]] NotificationInvoked_revoker NotificationInvoked(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Windows::AppNotifications::AppNotificationManager, winrt::Microsoft::Windows::AppNotifications::AppNotificationActivatedEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) NotificationInvoked(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(void) Show(winrt::Microsoft::Windows::AppNotifications::AppNotification const& notification) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<winrt::Microsoft::Windows::AppNotifications::AppNotificationProgressResult>) UpdateAsync(winrt::Microsoft::Windows::AppNotifications::AppNotificationProgressData const& data, param::hstring const& tag, param::hstring const& group) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<winrt::Microsoft::Windows::AppNotifications::AppNotificationProgressResult>) UpdateAsync(winrt::Microsoft::Windows::AppNotifications::AppNotificationProgressData const& data, param::hstring const& tag) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Windows::AppNotifications::AppNotificationSetting) Setting() const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncAction) RemoveByIdAsync(uint32_t notificationId) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncAction) RemoveByTagAsync(param::hstring const& tag) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncAction) RemoveByTagAndGroupAsync(param::hstring const& tag, param::hstring const& group) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncAction) RemoveByGroupAsync(param::hstring const& group) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncAction) RemoveAllAsync() const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Foundation::Collections::IVector<winrt::Microsoft::Windows::AppNotifications::AppNotification>>) GetAllAsync() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Windows::AppNotifications::AppNotificationManager) Default() const;
    };
    ...
    struct consume_Microsoft_Windows_AppNotifications_IAppNotificationProgressData
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) ValueStringOverride() const;
        WINRT_IMPL_AUTO(void) ValueStringOverride(param::hstring const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) Status() const;
        WINRT_IMPL_AUTO(void) Status(param::hstring const& value) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::Windows::AppNotifications::AppNotificationProgressData) CreateInstance(uint32_t sequenceNumber) const;
    };
