...
{
    struct __declspec(empty_bases) AppWindow : winrt::Microsoft::UI::Windowing::IAppWindow,
    ...
    struct __declspec(empty_bases) AppWindowChangedEventArgs : winrt::Microsoft::UI::Windowing::IAppWindowChangedEventArgs,
    ...
    struct __declspec(empty_bases) AppWindowClosingEventArgs : winrt::Microsoft::UI::Windowing::IAppWindowClosingEventArgs
    {
    ...
    struct __declspec(empty_bases) AppWindowPresenter : winrt::Microsoft::UI::Windowing::IAppWindowPresenter
    {
    ...
    struct __declspec(empty_bases) AppWindowTitleBar : winrt::Microsoft::UI::Windowing::IAppWindowTitleBar,
    ...
    struct __declspec(empty_bases) CompactOverlayPresenter : winrt::Microsoft::UI::Windowing::ICompactOverlayPresenter,
    ...
    struct __declspec(empty_bases) DisplayArea : winrt::Microsoft::UI::Windowing::IDisplayArea
    {
    ...
    struct __declspec(empty_bases) DisplayAreaWatcher : winrt::Microsoft::UI::Windowing::IDisplayAreaWatcher
    {
    ...
    struct __declspec(empty_bases) FullScreenPresenter : winrt::Microsoft::UI::Windowing::IFullScreenPresenter,
    ...
    struct __declspec(empty_bases) OverlappedPresenter : winrt::Microsoft::UI::Windowing::IOverlappedPresenter,
