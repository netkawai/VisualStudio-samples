...
WINRT_EXPORT namespace winrt::Microsoft::Windows::AppLifecycle
{
    ...
    struct __declspec(empty_bases) AppActivationArguments : winrt::Microsoft::Windows::AppLifecycle::IAppActivationArguments
    {
    ...
    struct __declspec(empty_bases) AppInstance : winrt::Microsoft::Windows::AppLifecycle::IAppInstance
    {
