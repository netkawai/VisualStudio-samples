...
namespace CommunityToolkit.WinUI.Notifications
{
...
#endif
    {
        ...
        private async global::System.Threading.Tasks.Task ShowAsyncHelper(CustomizeToastAsync customize)
        {
        ...
        private async global::System.Threading.Tasks.Task ScheduleAsyncHelper(DateTimeOffset deliveryTime, CustomizeScheduledToastAsync customize = null)
        {
            var notif = new Windows.UI.Notifications.ScheduledToastNotification(GetToastContent().GetXml(), deliveryTime);
